...
def display_interactive_board(game, board_id):
    ...
    return game_over  # Return the game_over flag
...
game_over = display_interactive_board(game, st.session_state.board_id)  # Call function and get game_over status

if not game_over:  # Only display these if the game is not over
